...
init(
  group(
    ...
    { expanded: false },
      ...
      default: "<h1>FACILITIES FOR ALL!</h1>",
    }),
  ),
  group(
    "Trainers Section",
    ...
    { expanded: true },
      ...
      default: "<h6>Trainers</h6>",
    }),
    fi.richtext("Trainer Description", "trainer_description", {
      default:
        "<p>From strength training and HIIT to yoga, Pilates, and recovery — explore over 20+ online classes designed to keep you motivated, challenged, and coming back for more.</p>",
    }),
  ...
  group(
    ...
    fi.richtext("Bottom Left Overlay Text", "overlay_text", {
      default: "<h6>Let's hit body goals!</h6>",
    }),
